...
import config
'''
Read configurations from the jason file
'''

d_model = config.d_model
n_head = config.num_heads #number of heads 
d_word = config.glove_dim 
d_char = config.char_dim #char embedding
batch_size = config.batch_size # 
dropout = config.dropout # 
dropout_char = config.dropout_char 

d_k = d_model // n_head
d_cq = d_model * 4 #context query awared dim 
